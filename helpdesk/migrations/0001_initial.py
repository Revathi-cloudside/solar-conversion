...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BaseEventAssociation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.CharField(db_index=True, max_length=100)),
                ('created', models.DateTimeField(db_index=True, help_text='Time at which this association was created')),
                ...
                ('energy_loss_cause', models.CharField(blank=True, choices=[('GRID_NOT_AVAILABLE', 'GRID_UNAVAILABILITY'), ('NO_INVERTER_GENERATION', 'NO_INVERTER_GENERATION'), ('INVERTER_INTERNAL_ALARMS', 'INVERTER_INTERNAL_ALARMS'), ('SOILING_LOSS', 'SOILING_LOSS'), ('INVERTER_UNDERPERFORMING', 'INVERTER_UNDERPERFORMING'), ('MPPT_UNDERPERFORMING', 'MPPT_UNDERPERFORMING'), ('STRING_UNDERPERFORMING', 'STRING_UNDERPERFORMING')], max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomField',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_status', models.IntegerField(blank=True, choices=[(1, 'Open'), (6, 'Acknowledged'), (2, 'Reopened'), (3, 'Resolved'), (4, 'Closed'), (5, 'Duplicate')], help_text='If the status was changed, what was it changed to?', null=True, verbose_name='New Status')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_ticket_sms', models.CharField(blank=True, help_text='If a phone number is entered here, then it will receive notification of all new tickets created for this queue. Enter a comma between multiple numbers.', max_length=200, null=True, verbose_name='New Ticket SMS numbers')),
                ...
                ('email_box_type', models.CharField(blank=True, choices=[('pop3', 'POP 3'), ('imap', 'IMAP')], help_text='E-Mail server type for creating tickets automatically from a mailbox - both POP3 and IMAP are supported.', max_length=5, null=True, verbose_name='E-Mail Box Type')),
                ...
                ('permission_name', models.CharField(blank=True, editable=False, help_text='Name used in the django.contrib.auth permission system', max_length=50, null=True, verbose_name='Django auth permission name')),
                ...
                ('default_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='default_owner', to=settings.AUTH_USER_MODEL, verbose_name='Default owner')),
                ('plant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queues', to='solarrms.solarplant')),
            ],
            options={
                'verbose_name': 'Queue',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, db_index=True, help_text='Date this ticket was first created', verbose_name='Created')),
                ('modified', models.DateTimeField(blank=True, db_index=True, help_text='Date this ticket was most recently changed.', verbose_name='Modified')),
                ...
                ('status', models.IntegerField(choices=[(1, 'Open'), (6, 'Acknowledged'), (2, 'Reopened'), (3, 'Resolved'), (4, 'Closed'), (5, 'Duplicate')], db_index=True, default=1, verbose_name='Status')),
                ...
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket', related_query_name='tickets', to='helpdesk.queue', verbose_name='Queue')),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier_name', models.CharField(blank=True, max_length=200, null=True)),
                ('event_type', models.CharField(choices=[('GATEWAY_POWER_OFF', 'GATEWAY_POWER_OFF'), ('GATEWAY_DISCONNECTED', 'GATEWAY_DISCONNECTED'), ('INVERTERS_DISCONNECTED', 'INVERTERS_DISCONNECTED'), ('AJBS_DISCONNECTED', 'AJBS_DISCONNECTED'), ('INVERTERS_NOT_GENERATING', 'INVERTERS_NOT_GENERATING'), ('INVERTERS_ALARMS', 'INVERTERS_ALARMS'), ('AJB_STRING_CURRENT_ZERO_ALARM', 'AJB_STRING_CURRENT_ZERO_ALARM'), ('PANEL_CLEANING', 'PANEL_CLEANING'), ('INVERTERS_UNDERPERFORMING', 'INVERTERS_UNDERPERFORMING'), ('MPPT_UNDERPERFORMING', 'MPPT_UNDERPERFORMING'), ('AJB_UNDERPERFORMING', 'AJB_UNDERPERFORMING'), ('CUSTOM_TICKET', 'CUSTOM_TICKET')], db_index=True, max_length=50)),
                ('created', models.DateTimeField(db_index=True, help_text='Time at which this association was created')),
                ('updated', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('energy_loss', models.FloatField(blank=True, null=True)),
                ...
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='associations', related_query_name='associations', to='helpdesk.ticket')),
            ],
        ),
        migrations.CreateModel(
            name='SavedSearch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('priority', models.IntegerField(choices=[(1, '1. Critical'), (2, '2. High'), (3, '3. Normal'), (4, '4. Low'), (5, '5. Very Low')])),
                ('level', models.IntegerField(choices=[(1, '1. Level 1 escalation'), (2, '2. Level 2 escalation'), (3, '3. Level 3 escalation')])),
                ('SLA', models.IntegerField(help_text='In minutes')),
                ('escalate_to_email', models.EmailField(blank=True, help_text='Email id for this type of escalation', max_length=254, null=True)),
                ('escalate_to_phone', models.CharField(blank=True, help_text='Mobile number for this type of escalation', max_length=15, null=True)),
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slaqueue', related_query_name='slaqueue', to='helpdesk.queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='AnalyticsAssociation',
            fields=[
                ('baseeventassociation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='helpdesk.baseeventassociation')),
                ('st', models.DateTimeField(default=None)),
                ('et', models.DateTimeField(default=None)),
                ('delta_energy', models.FloatField(blank=True, default=None, null=True)),
                ('delta_current', models.FloatField(blank=True, default=None, null=True)),
                ('actual_power', models.FloatField(blank=True, default=None, null=True)),
                ('mean_power', models.FloatField(blank=True, default=None, null=True)),
                ('delta_power', models.FloatField(blank=True, default=None, null=True)),
                ('mean_energy', models.FloatField(blank=True, default=None, null=True)),
                ('mean_current', models.FloatField(blank=True, default=None, null=True)),
                ('actual_energy', models.FloatField(blank=True, default=None, null=True)),
                ('expected_energy', models.FloatField(blank=True, default=None, null=True)),
                ('actual_current', models.FloatField(blank=True, default=None, null=True)),
                ('residual', models.FloatField(blank=True, default=None, null=True)),
                ('mean_voltage', models.FloatField(blank=True, default=None, null=True)),
                ('ticket_association', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performance_associations', related_query_name='performance_association', to='helpdesk.ticketassociation')),
            ],
            bases=('helpdesk.baseeventassociation',),
        ),
        migrations.CreateModel(
            name='AlarmAssociation',
            fields=[
                ('baseeventassociation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='helpdesk.baseeventassociation')),
                ('device_status_number', models.FloatField(help_text='solar status, cannot be None')),
                ('alarm_code', models.CharField(blank=True, help_text='corresponding error code, optional', max_length=20, null=True)),
                ('alarm_description', models.CharField(blank=True, max_length=1000, null=True)),
                ('alarm_resolution', models.CharField(blank=True, max_length=1000, null=True)),
                ('device_status_description', models.CharField(blank=True, max_length=500, null=True)),
                ('expected_energy', models.FloatField(blank=True, null=True)),
                ('actual_energy', models.FloatField(blank=True, null=True)),
                ('ticket_association', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alarms', related_query_name='alarm', to='helpdesk.ticketassociation')),
            ],
            bases=('helpdesk.baseeventassociation',),
        ),
    ]
