...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('helpdesk_presetreply_queues', (
            ...
            ('presetreply', models.ForeignKey(orm['helpdesk.presetreply'], on_delete=models.CASCADE, null=False)),
            ('queue', models.ForeignKey(orm['helpdesk.queue'], on_delete=models.CASCADE, null=False))
        ))
        ...
        db.create_table('helpdesk_escalationexclusion_queues', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('escalationexclusion', models.ForeignKey(orm['helpdesk.escalationexclusion'], on_delete=models.CASCADE, null=False)),
            ('queue', models.ForeignKey(orm['helpdesk.queue'], on_delete=models.CASCADE, null=False))
        ))
        ...
        db.create_table('helpdesk_ignoreemail_queues', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ignoreemail', models.ForeignKey(orm['helpdesk.ignoreemail'], on_delete=models.CASCADE, null=False)),
            ('queue', models.ForeignKey(orm['helpdesk.queue'], on_delete=models.CASCADE, null=False))
        ))
