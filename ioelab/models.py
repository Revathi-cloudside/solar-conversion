...
class Invite(models.Model):
    ...
    invitee =  models.ForeignKey(User, on_delete=models.CASCADE, related_name = "ioeinvites_sent",blank=True, related_query_name="ioeinvites_sent", help_text="invitee name")
