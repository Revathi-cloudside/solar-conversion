...
class ChargeController(Sensor):
    ...
    plant = models.ForeignKey(SolarPlant, on_delete=models.CASCADE, related_name="charge_controllers")
...
class PanelSet(IndependentInverter):
    ...
    charge_controller = models.ForeignKey(ChargeController, on_delete=models.CASCADE,
