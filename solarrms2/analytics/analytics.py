        ...
        if plants_group is not None:
            for plant in plants_group:
                ...
                if len(panel_cleaning_details)>0:
                    try:
                        inverters_cleaning_list.extend(list(panel_cleaning_details['PANEL_CLEANING']['details'].keys()))
                    except:
                        pass
                    try:
                        if len(panel_cleaning_details['PANEL_CLEANING'])>0:
                            ...
                            plant_panel_cleaning_details['devices'] = ",".join(list(panel_cleaning_details['PANEL_CLEANING']['details'].keys()))
