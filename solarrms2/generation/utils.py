...
# device
def a(xxx_todo_changeme):
    (key, stream) = xxx_todo_changeme
...
def get_inverter_power(xxx_todo_changeme1):
    (binning_interval, inverter_key, stream, starttime, endtime) = xxx_todo_changeme1
    from cassandra.cluster import Cluster
    from cassandra.auth import PlainTextAuthProvider
    from cassandra.query import dict_factory
    from cassandra.cqlengine import connection
