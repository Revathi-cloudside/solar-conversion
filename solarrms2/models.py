...
PRIORITY = list(zip(PRIORITY_VALUES, PRIORITY_VALUES))
...
class BillingEntity(models.Model):
    ...
    # company details
    dataglen_client = models.OneToOneField(DataglenClient, on_delete=models.CASCADE, related_name="billing_entity")
...
class BankAccount(models.Model):
    billing_entity = models.ForeignKey(BillingEntity, on_delete=models.CASCADE, related_name="accounts", null=True, blank=True)
    # bank details
...
class EnergyContract(models.Model):
    ...
    plant = models.ForeignKey(SolarPlant, on_delete=models.CASCADE, blank=False, null=False, related_name="energy_contract")
    # off taker/client
    off_taker = models.ForeignKey(EnergyOffTaker, on_delete=models.CASCADE, blank=False, null=False, related_name="energy_contract")
    # ppa price
...
class SolarEventsPriorityMapping(models.Model):
    ...
    client = models.ForeignKey(DataglenClient, on_delete=models.CASCADE, related_name="events_priorities")
