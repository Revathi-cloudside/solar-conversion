    ...
    try:
        ...
        if plants_group is not None:
            for plant in plants_group:
                ...
                for key in list(ticket_detail.keys()):
        ...
        if plants_group is not None:
            for plant in plants_group:
                ...
                if len(plant_network_details)>0:
                    try:
                        gateways_disconnected_list.extend(list(plant_network_details['GATEWAY_DISCONNECTED']['details'].keys()))
                    except:
                        pass
                    try:
                        gateways_powered_off_list.extend(list(plant_network_details['GATEWAY_POWER_OFF']['details'].keys()))
                    except:
                        pass
                    ...
                    try:
                        if len(plant_network_details['GATEWAY_DISCONNECTED'])>0:
                            ...
                            plant_gateway_disconnected_details['devices'] = ",".join(list(plant_network_details['GATEWAY_DISCONNECTED']['details'].keys()))
                    ...
                    try:
                        if len(plant_network_details['GATEWAY_POWER_OFF'])>0:
                            ...
                            plant_gateway_powered_off_details['devices'] = ",".join(list(plant_network_details['GATEWAY_POWER_OFF']['details'].keys()))
    ...
    try:
        ...
        if plants_group is not None:
            for plant in plants_group:
                ...
                if len(plant_network_details)>0:
                    try:
                        smbs_disconnected_list.extend(list(plant_network_details['AJBS_DISCONNECTED']['details'].keys()))
                    except:
                        pass
                    ...
                    try:
                        if len(plant_network_details['AJBS_DISCONNECTED'])>0:
                            ...
                            plant_smb_disconnected_details['devices'] = ",".join(list(plant_network_details['AJBS_DISCONNECTED']['details'].keys()))
    ...
    try:
        ...
        if plants_group is not None:
            for plant in plants_group:
                ...
                if len(plant_network_details)>0:
                    try:
                        inverters_disconnected_list.extend(list(plant_network_details['INVERTERS_DISCONNECTED']['details'].keys()))
                    except:
                        pass
                    try:
                        inverters_alarms_list.extend(list(plant_network_details['INVERTERS_ALARMS']['details'].keys()))
                    except:
                        pass
                    ...
                    try:
                        if len(plant_network_details['INVERTERS_DISCONNECTED'])>0:
                            ...
                            plant_inverters_disconnected_details['devices'] = ",".join(list(plant_network_details['INVERTERS_DISCONNECTED']['details'].keys()))
                    ...
                    try:
                        if len(plant_network_details['INVERTERS_ALARMS'])>0:
                            ...
                            plant_inverters_alarms_details['devices'] = ",".join(list(plant_network_details['INVERTERS_ALARMS']['details'].keys()))
