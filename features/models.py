...
class DGClientSubscription(models.Model):
    ...
    dg_client = models.ForeignKey(DataglenClient, on_delete=models.CASCADE,
...
class CustomFeature(models.Model):
    ...
    features = models.ForeignKey(Feature, on_delete=models.CASCADE, blank=False, null=False,related_name="custom_feature")
...
class CustomReportFormat(models.Model):
    ...
    dg_client = models.ForeignKey(DataglenClient, on_delete=models.CASCADE, null=False, blank=False, related_name="custom_report")
    role = models.CharField(max_length=100, null=False, blank=False, choices=SOLAR_USER_ROLE)
