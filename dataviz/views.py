...
def index(request):
    ...
    return render(request, 'dataviz/visualization.html', {'result_set': {}, 'premise_loads' : premise_loads, 'premise_list':list(premise_loads.keys())})
...
def show_live_data(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'dataviz/visualization.html', {'result_set': result_set, 'premise_loads' : premise_loads, 'premise_list':list(premise_loads.keys())})
    else:
        return render(request, 'dataviz/visualization.html', {'result_set': {}, 'premise_loads' : premise_loads, 'premise_list':list(premise_loads.keys())})
...
def generate_data_status(request):
    ...
    if request.method == "GET":
        try:
            for premise in list(premise_loads.keys()):
