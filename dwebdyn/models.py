...
class WebdynGateway(models.Model):
    client = models.ForeignKey(WebdynClient, on_delete=models.CASCADE, related_name="gateways", related_query_name="client", to_field="name",
            ...
            for block in blocks[1:]:
                ...
                try:
                    ...
                    for line in lines[3:]:
                        ...
                        device_data = {}
                        for key in list(MODBUS_TEMPLATES[modbus_device.fields_template]["DATA"].keys()):
...
class InvertersDevice(models.Model):
    gateway_device = models.ForeignKey(WebdynGateway, on_delete=models.CASCADE, related_name="inverter_devices",
    ...
    fields_template = models.CharField(max_length=30, choices=INVERTERS_MANUFACTURERS, blank=False, null=False,
...
class ModbusDevice(models.Model):
    gateway_device = models.ForeignKey(WebdynGateway, on_delete=models.CASCADE, related_name="modbus_devices", related_query_name="gateway",
...
class IODevice(models.Model):
    gateway_device = models.ForeignKey(WebdynGateway, on_delete=models.CASCADE, related_name="io_devices", related_query_name="gateway",
                                       to_field="id",
