...
class Sensor(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name = "data_source", related_query_name="data_source")
...
class Field(models.Model):
    # associated sensor
    source = models.ForeignKey(Sensor, on_delete=models.CASCADE,
                               related_name = "fields",
...
class SensorGroup(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name = "group_data_source", related_query_name="group_data_source")
