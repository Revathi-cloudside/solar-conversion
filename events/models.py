...
class EventsConfig(models.Model):
    source_key = models.ForeignKey(Sensor, on_delete=models.CASCADE,
...
class UserEventAlertsPreferences(models.Model):
    event = models.ForeignKey(Events, on_delete=models.CASCADE, related_name='preferences', related_query_name='preference',
...
class AlertManagement(models.Model):
    event = models.ForeignKey(Events, on_delete=models.CASCADE, related_name='alerts',
