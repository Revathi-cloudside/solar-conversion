...
import datetime, sys, dateutil, logging, http.client
...
def events_write(request,
    ...
    try:
        ...
        response = HttpResponse("event logged", status=http.client.OK)
