...
class TaskItem(models.Model):
    task = models.ForeignKey(TasksList, on_delete=models.CASCADE, related_name="tasks", related_query_name="tasks")
...
class TaskAssociation(models.Model):
    task_item = models.ForeignKey(TasksList, on_delete=models.CASCADE, related_name="associations", related_query_name="associations")
    sensor = models.ForeignKey(Sensor, on_delete=models.CASCADE, related_name="task_associations",
