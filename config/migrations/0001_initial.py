    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='config', max_length=10)),
                ('source', models.ForeignKey(help_text='Key of the source this stream belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='configfields', related_query_name='configfield', to='dataglen.sensor', to_field='sourceKey')),
            ],
            options={
