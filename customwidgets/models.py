...
class UserConfiguration(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_query_name="configuration",
...
class WidgetInstance(models.Model):
    configuration = models.ForeignKey(UserConfiguration, on_delete=models.CASCADE,
