...
class QueryOption(models.Model):
    ...
    dashboard = models.ForeignKey(Dashboard, on_delete=models.CASCADE, related_name="analysis_queries",
    ...
    # child query
    parent_query = models.ForeignKey("QueryOption", on_delete=models.CASCADE, related_query_name="child_query",
...
class DataAnalysis(models.Model):
    ...
    dg_client = models.ForeignKey(DataglenClient, on_delete=models.CASCADE, null=True, blank=True, related_name="data_analysis",
    ...
    # created by
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name="data_analysis",
                                   related_query_name="data_analysis")
...
class DataSlice(models.Model):
    ...
    # analysis name
    analysis = models.ForeignKey(DataAnalysis, on_delete=models.CASCADE, related_name="slices",
    ...
    query_options = models.ForeignKey(QueryOption, on_delete=models.CASCADE, related_name="slices",
                                      related_query_name="slices")
    css_options = models.OneToOneField(CssTemplate, on_delete=models.CASCADE, related_name="slice",
    ...
    instantaneous_aggregation = models.ForeignKey(AggregationFunction, on_delete=models.CASCADE,
    ...
    # daily aggregation
    daily_aggregation = models.ForeignKey(AggregationFunction, on_delete=models.CASCADE,
                                          related_name="daily_slices",
                                          related_query_name="daily_slices")

    # monthly aggregation
    monthly_aggregation = models.ForeignKey(AggregationFunction, on_delete=models.CASCADE,
                                            related_name="monthly_slices",
                                            related_query_name="monthly_slices")

    # parent slice
    parent_slice = models.ForeignKey("DataSlice", on_delete=models.CASCADE, related_query_name="child_slice",
...
class AnalysisDashboard(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name="saved_dashboards",
    ...
    css = models.OneToOneField(CssTemplate, on_delete=models.CASCADE, related_name="dashboard",
...
class AnalysisConfiguration(models.Model):
    # saved analysis
    analysis = models.ForeignKey(DataAnalysis, on_delete=models.CASCADE, related_name="saved_dashboards",
                                 related_query_name="saved_dashboards", null=False, blank=False)
    # dashboard
    dashboard = models.ForeignKey(AnalysisDashboard, on_delete=models.CASCADE, related_name="analysis_configurations",
    ...
    # saved by which user
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name="saved_dashboards_analysis",
    ...
    css = models.OneToOneField(CssTemplate, on_delete=models.CASCADE, related_name="analysis_configuration",
