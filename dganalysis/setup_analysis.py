...
aggregation_functions = [
 (1, 'Values Sum', '{"sum_value": doublesum("%s")}', 'sum_value', '', '',
  'sum_value', 'stream_value'),
 (2, 'Maximum Value', '"max_value": doublemax("%s")}', 'max_value', '', '',
  'max_value', 'stream_value'),
 (3, 'Minimum Value', '{"min_value": doublemin("%s")}', 'min_value', '', '',
  'min_value', 'stream_value'),
 (4, 'First Value of the period',
  '{"first_value": doublefirst("%s")}', 'first_value', '', '',
  'first_value','stream_value'),
 (5, 'Last Value of the period',
  '{"last_value": doublelast("%s")}',
  'last_value',
  '',
  '',
  'last_value',
  'stream_value'),
 (6, '(Last-First) Value of the period',
  '{"first_value": doublefirst("%s"), "last_value": doublelast("%s")}',
  'first_value, last_value',
  "{'last_minus_first': (HyperUniqueCardinality('last_value') - HyperUniqueCardinality('first_value'))}",
  'last_minus_first',
  'last_minus_first',
  'stream_value'),
 (7, 'Count',
  ...
  'stream_value'),
 (8, 'Average Value',
  '{"avg_sum_value": doublesum("%s"), "avg_count_value": count("%s")}',
  'avg_sum_value, avg_count_value',
  '{"avg_value": (Field("avg_count_value") / Field("avg_sum_value"))}',
  'avg_value',
  'avg_value',
  'stream_value'),
]
...
def create_analysis_dict():
    ...
    for analysis in DataAnalysis.objects.all():
        ...
        analysis_dict['slices'] = list(slices_values.values())
